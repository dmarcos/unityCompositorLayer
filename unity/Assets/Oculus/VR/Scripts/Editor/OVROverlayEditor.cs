...
public class OVROverlayEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
...
#endif
		{
			...
			//overlay.shaderName = EditorGUILayout.TextField("Shader Name", overlay.shaderName);
			//overlay.forceUpdate = EditorGUILayout.Toggle("Force Update", overlay.forceUpdate);
